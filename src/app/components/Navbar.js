          ...
          <div className="flex justify-between items-center h-16">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <div className="hidden sm:flex flex-col leading-tight">
                <span className="font-bold text-primary-navy text-base tracking-wide" style={{ fontFamily: "'Playfair Display', serif" }}>Madurai Institute of Social Sciences (Autonomous)</span>
              </div>
            </Link>
            ...
            <div className="hidden xl:flex items-center gap-2">
              ...
              <Link
                href="/admissions"
                className="px-4 py-2 rounded-lg bg-gradient-to-r from-[#EAEFEF] to-blue-600 text-white hover:from-primary-navy hover:to-primary-navy transition-all duration-200 font-semibold text-sm shadow-md hover:shadow-lg"
              >
                Apply Now
              </Link>
            </div>
