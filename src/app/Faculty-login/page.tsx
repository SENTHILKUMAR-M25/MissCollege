    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-white text-2xl font-bold">Faculty Portal Login</h1>
          <p className="text-slate-400 text-sm mt-2">Enter your credentials to access the faculty portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-900 border border-white/10 rounded-2xl p-6 space-y-5">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-teal-500 to-emerald-500 text-white text-sm font-semibold hover:opacity-90 disabled:opacity-50 transition shadow-lg shadow-teal-500/25 flex items-center justify-center gap-2"
          >
        ...
        <div className="flex items-center justify-center gap-4 text-xs mt-6">
          <a href="/forgot-password" className="text-teal-400 hover:text-teal-300 transition-colors">Forgot Password?</a>
          <a href="/admin-login" className="text-violet-400 hover:text-violet-300 transition-colors">Admin Login</a>
        </div>
      </motion.div>
    </div>
  )
