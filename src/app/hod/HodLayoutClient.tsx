...
import {
  ...
  FileText, LogOut, ChevronLeft, School, Bell,
  ClipboardList, GraduationCap, Award, TrendingUp, Briefcase,
} from "lucide-react"
...
const navGroups: { group: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Student Management", href: "/hod/students", icon: GraduationCap },
      { label: "Subject Management", href: "/hod/subjects", icon: BookOpen },
      { label: "Work Allocation", href: "/hod/faculty-allocation", icon: Briefcase },
  ...
  },
  {
    group: "Operations",
    items: [
      { label: "Attendance", href: "/hod/attendance", icon: ClipboardList },
      { label: "Leave Requests", href: "/hod/leave", icon: FileText },
      { label: "Examinations", href: "/hod/examinations", icon: Award },
      { label: "Notices", href: "/hod/notices", icon: Bell },
      { label: "Reports", href: "/hod/reports", icon: TrendingUp },
    ],
  },
]
...
export default function HodLayoutClient({
  children,
  departmentName,
  userName,
  userEmail,
